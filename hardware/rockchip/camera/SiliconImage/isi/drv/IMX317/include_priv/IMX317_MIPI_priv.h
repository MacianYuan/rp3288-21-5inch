...
/*
#ifndef _IMX317_PRIV_H
#define _IMX317_PRIV_H

#include "isi_priv.h"

#if( IMX317_DRIVER_USAGE == USE_CAM_DRV_EN )
*/


#ifndef __IMX317_PRIV_H__
#define __IMX317_PRIV_H__
...
*v0.3.0 : change IMX317 2lane register setting from external to internal 
*v0.4.0 : fix exposure and awb capture in setting -- oyyf
*
*/

#define CONFIG_SENSOR_DRV_VERSION KERNEL_VERSION(0, 4, 0x01) 
