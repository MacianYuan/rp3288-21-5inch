...
/*
#ifndef _ar0330_PRIV_H
#define _ar0330_PRIV_H
...
#ifndef __ar0330_PRIV_H__
#define __ar0330_PRIV_H__
...
*v0.2.0 : modify ar0330 driver --oyyf
*v0.3.0 : support OTP
...
#define Sensor_CHIP_ID_HIGH_BYTE            (0x31fc) // r - 
#define Sensor_CHIP_ID_LOW_BYTE          (0x31fc) // r - 

#define Sensor_CHIP_ID_HIGH_BYTE_DEFAULT            (0x3020) // r - 
#define Sensor_CHIP_ID_LOW_BYTE_DEFAULT          (0x3020) // r - 

#define Sensor_MODE_SELECT  (0x301a)

#define Sensor_SOFTWARE_RST                 (0x3021) // rw - Bit[7:1]not used  Bit[0]software_reset
