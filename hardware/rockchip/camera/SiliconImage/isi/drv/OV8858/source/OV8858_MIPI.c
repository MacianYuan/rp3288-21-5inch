...
extern const IsiRegDescription_t OV8858_g_1632x1224P7_twolane_fpschg[];
...
)
{
    ...
    else
    {
		...
		case 7:
                {
                    pIsiSensorCaps->Resolution = ISI_RES_1632_1224P7;
                    break;
                }
#endif
                default:
...
const IsiSensorCaps_t OV8858_g_IsiSensorDefaultConfig =
{
    ...
    ISI_GAMMA_OFF,              // Gamma
    ISI_CCONV_OFF,              // CConv
    ISI_RES_3264_2448P15, 		// resolution
...
)
{
	...
	TRACE( OV8858_INFO, "%s (enter) g_sensor_version is %02x\n", __FUNCTION__ , g_sensor_version);
...
)
{
    ...
    result = OV8858_IsiRegWriteIss ( pOV8858Ctx, OV8858_SOFTWARE_RST, OV8858_SOFTWARE_RST_VALUE );//ºê¶¨Òå hkw£»
    RETURN_RESULT_IF_DIFFERENT( RET_SUCCESS, result );
...
)
{
    ...
    usGain = (uint16_t)(NewGain * OV8858_MAXN_GAIN+0.5); //´ó¸Å¼Ó0.5 hkw
