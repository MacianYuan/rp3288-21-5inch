#ifndef __IMX291_PRIV_H__
#define __IMX291_PRIV_H__
...
*
*v0.1.0 : create file
*v0.2.0 : update hts&vts
*/

#define CONFIG_SENSOR_DRV_VERSION KERNEL_VERSION(0, 0x2, 0x00) 


#define Sensor_CHIP_ID_HIGH_BYTE            (0x3018) // r - 
#define Sensor_CHIP_ID_LOW_BYTE             (0x3019) // r - 

#define Sensor_CHIP_ID_HIGH_BYTE_DEFAULT    (0x65) // r - 
#define Sensor_CHIP_ID_LOW_BYTE_DEFAULT     (0x04) // r - 
