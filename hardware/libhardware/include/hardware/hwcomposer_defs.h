...
enum {
  HWC_POWER_MODE_EPD_NULL           = -1,
  HWC_POWER_MODE_EPD_AUTO           = 0,
  HWC_POWER_MODE_EPD_FULL           = 1,
  HWC_POWER_MODE_EPD_A2             = 2,
  HWC_POWER_MODE_EPD_PART           = 3,
  HWC_POWER_MODE_EPD_FULL_DITHER    = 4,
  HWC_POWER_MODE_EPD_RESET          = 5,
  HWC_POWER_MODE_EPD_BLACK_WHITE    = 6,
  HWC_POWER_MODE_EPD_TEXT           = 7,
  HWC_POWER_MODE_EPD_BLOCK          = 8,
  HWC_POWER_MODE_EPD_FULL_WIN       = 9,
  HWC_POWER_MODE_EPD_OED_PART       = 10,
  HWC_POWER_MODE_EPD_DIRECT_PART    = 11,
  HWC_POWER_MODE_EPD_DIRECT_A2      = 12,
  HWC_POWER_MODE_EPD_STANDBY        = 13,
  HWC_POWER_MODE_EPD_POWEROFF       = 14,
};
