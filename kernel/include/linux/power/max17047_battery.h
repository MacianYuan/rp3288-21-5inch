...
#define MAX17047_LONG_DELAY			msecs_to_jiffies(2000)
//bill
//#define MAX17047_SHORT_DELAY		0
#define MAX17047_NO_DELAY		0
#define MAX17047_RESUME_DELAY		msecs_to_jiffies(6000)
#define MAX17047_SHORT_DELAY		msecs_to_jiffies(1000)
