...
#define GTP_KEY_TAB	 {KEY_BACK, KEY_HOMEPAGE, KEY_MENU, KEY_POWER}
...
#define GTP_CONFIG_MAX_LENGTH       260
...
extern struct property *prope;
extern int gtp_wakeup;
...
extern struct gtp_config_custom *gtp_config;
