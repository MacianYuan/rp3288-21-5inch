			...
			enum snd_soc_bias_level level)
{
	...
	case SND_SOC_BIAS_PREPARE:
		...
		rt5631_write_mask(codec, RT5631_PWR_MANAG_ADD2,
			RT5631_PWR_MICBIAS1_VOL_BIT | RT5631_PWR_MICBIAS2_VOL_BIT,
			RT5631_PWR_MICBIAS1_VOL_BIT | RT5631_PWR_MICBIAS2_VOL_BIT);
		break;
...
printk("bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb\n");
	rt5631_reset(codec);
	snd_soc_update_bits(codec, RT5631_PWR_MANAG_ADD3,
...
printk("cccccccccccccccccccccccccccccccccccccccc\n");
	msleep(80);
	snd_soc_update_bits(codec, RT5631_PWR_MANAG_ADD3,
...
printk("dddddddddddddddddddddddddddddddddd\n");
	if (rt5631->codec_version)
		...
		snd_soc_update_bits(codec, RT5631_INT_ST_IRQ_CTRL_2,
					0x2000, 0);
printk("eeeeeeeeeeeeeeeeeeeeeeeeeeeeee\n");
	// DMIC
...
printk("fffffffffffffffffffffffffffffffff\n");
