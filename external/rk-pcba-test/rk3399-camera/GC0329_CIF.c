...
struct rk_sensor_reg gc0329_sensor_test[] = {
 	{0xfe , 0xf0},
 	{0xfe , 0xf0},
 	{0xfe , 0xf0},
 	{0xfc , 0x06},
...
int Gc0329_sensor_reg_init(int camsys_fd,unsigned int *i2cbase)
{
	...
	sensor_reg = gc0329_sensor_test;
	size = sizeof(gc0329_sensor_test)/sizeof(struct rk_sensor_reg);
...
int Gc0329_get_SensorInfo(rk_camera_info_t *rk_camera_info)
{
	...
	strlcpy((char*)rk_camera_info->sensorname, "GC0329",sizeof(rk_camera_info->sensorname));
