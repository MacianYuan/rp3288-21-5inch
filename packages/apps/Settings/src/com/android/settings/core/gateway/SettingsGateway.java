...
import com.android.settings.UsbHostDeviceSetting;//add by rpdzkj yang for config usb host or device mode
...
public class SettingsGateway {
    ...
    public static final String[] ENTRY_FRAGMENTS = {
            ...
            UsbHostDeviceSetting.class.getName(), //add by rpdzkj yang for config usb host or device mode
    ...
    public static final String[] SETTINGS_FOR_RESTRICTED = {
            ...
            Settings.UsbHostDeviceSettingsActivity.class.getName(), //add by rpdzkj yang for config usb host or device mode
