...
//add by rpdzkj	
	private static final String ACTION_USB_PERMISSION = "com.rpdzkj.USB_PERMISSION";
	private boolean unCheckUsbPermission;
	private String no_usb_permission;
//add end	
    @Override
    public void requestDevicePermission(UsbDevice device, String packageName, PendingIntent pi) {
//add by rpdzkj

		no_usb_permission = SystemProperties.get("ro.rpdzkj.no.usb.permission","false");	
		if ("true".equals(no_usb_permission))
			unCheckUsbPermission = true;
		else
			unCheckUsbPermission = false;
//add end
        final int userId = UserHandle.getCallingUserId();
